...
def generate_launch_description():
    ...
    pcd_publish_node = Node(package='moveit_tutorials',
                            executable='pcd_publisher',
                            output='screen')

    return LaunchDescription([ rviz_node, to_panda, to_camera, to_camera_rgb, robot_state_publisher, run_move_group_node, fake_joint_driver_node, mongodb_server_node, pcd_publish_node ])
